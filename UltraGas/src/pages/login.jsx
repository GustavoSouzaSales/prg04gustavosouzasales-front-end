    ...
    <>
      ...
      <div className="green-curve-right">
        <svg viewBox="0 0 120 900" preserveAspectRatio="none">
          <path d="M 120 0 Q -30 300 60 600 Q 150 750 80 900" stroke="#00aaff" strokeWidth="1.5" fill="none" opacity="0.28" />
        </svg>
      </div>
        ...
        <div className="login-main-row">
          <div className="login-left">
            ...
            <div className="ultragaz-logo">
              <div className="logo-icon"><IconFlameLogo /></div>
            ...
            <div className="feature-grid">
              ...
              <div className="feature-card feature-card--accent">
                <div className="feature-icon feature-icon--accent"><IconTag /></div>
                <div className="feature-text">
